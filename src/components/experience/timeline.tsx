      ...
      <div ref={ref} className="relative mx-auto max-w-xl pb-20">
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute left-3 flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-black md:left-3">
                <div className="h-3 w-3 rounded-sm border border-primary-foreground dark:bg-primary" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-white from-[0%] via-slate-300 via-[10%] to-transparent"
          />
        </div>
      </div>
    </div>
